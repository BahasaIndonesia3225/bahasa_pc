  ...
  export default {
    ...
    methods: {
      login () {
        ...
        Loading.show();
        _this.$ajax.post(process.env.VUE_APP_SERVER + '/dev-api/system/admin/user/login', _this.user).then((response)=>{
          Loading.hide();
      ...
      loadImageCode: function () {
        ...
        $('#image-code').attr('src', process.env.VUE_APP_SERVER + '/dev-api/system/admin/kaptcha/image-code/' + _this.imageCodeToken);
      },
    }
  }
</script>
