...
export default {
  ...
  methods: {
    initTable() {
      this.$ajax.get(process.env.VUE_APP_SERVER + '/dev-api/business/admin/forum/listComment', { params: this.searchParams }).then((response)=>{
        const { data } = response;
        const { content } = data;
    ...
    handleApproveComment_(state, data) {
      const { id } = data;
      this.$ajax.post(process.env.VUE_APP_SERVER + '/dev-api/business/admin/forum/auditComment', { id, state }).then((response)=>{
        this.initTable();
        this.$message({
          message: '操作成功',
          type: 'success',
    ...
    handleDeleteComment(data) {
      const { id } = data;
      this.$ajax.post(process.env.VUE_APP_SERVER + '/dev-api/business/admin/forum/deleteComment?id=' + id).then((response)=>{
        this.initTable();
        this.$message({
          message: '删除成功',
          type: 'success',
