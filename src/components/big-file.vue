...
<script>
  export default {
    ...
    methods: {
      ...
      check (param) {
        let _this = this;
        _this.$ajax.get(process.env.VUE_APP_SERVER + '/dev-api/file/admin/check/' + param.key).then((response)=>{
      ...
      upload (param) {
        ...
        fileReader.onload = function (e) {
          ...
          _this.$ajax.post(process.env.VUE_APP_SERVER + '/dev-api/file/admin/' + _this.url, param).then((response) => {
            let resp = response.data;
